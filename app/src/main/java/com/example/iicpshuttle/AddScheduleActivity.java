...
public class AddScheduleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
                ...
                db.child("ShuttleSchedule").child(departure).child(date).child(time).child(uniqKey).setValue(shuttle).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(AddScheduleActivity.this, "Added successfully", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(AddScheduleActivity.this, "Added Failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
        ...
        DatabaseReference db = FirebaseDatabase.getInstance("https://iicpshuttle-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference();
        seatMap = new HashMap<>();
        db.child("Driver").addListenerForSingleValueEvent(new ValueEventListener() {
        ...
        db.child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(AddScheduleActivity.this, android.R.layout.simple_spinner_item, driver);
                adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        backToHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AddScheduleActivity.this, ManageScheduleActivity.class);
